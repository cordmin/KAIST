  ...
  4: {
    ...
    chapters: [
      ...
      // 4장
      {
        ...
        text: '새롭게 설계된 청색 발광 분자는 전기를 받는 즉시 열로 새지 않고, 정타를 맞은 야구공처럼 깨끗하고 푸른 빛을 시원하게 내뿜었습니다. 손목을 아프게 울리던 불필요한 진동(열)처럼 버려지던 75%의 에너지가 드디어 빛으로 살아난 것입니다. 화면 발열은 크게 줄어들었고, 배터리 사용 시간은 최대 두 배 가까이 늘어나게 되었습니다. 값비싼 귀금속 없이 순수한 분자 설계 기술만으로 이뤄낸 놀라운 성과입니다. 이제 대한민국 첨단 과학기술이 열어갈 더 밝고 편리한 미래 세상을 함께 탐구해 보세요!',
