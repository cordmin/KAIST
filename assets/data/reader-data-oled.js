  ...
  4: {
    ...
    chapters: [
      ...
      // 2장: 빗맞은 하이파이브
      {
        chapter: 2,
        tag: '제2장 · 빗맞은 하이파이브',
        title: '75%의 에너지가 열이 되는 비밀',
        lead: '친구와 신나게 하이파이브를 할 때, 손바닥 타이밍이 딱 맞으면 경쾌한 "짝!" 소리와 함께 시원한 바람이 터집니다.',
        paragraphs: [
          '하지만 박자가 어긋나서 빗맞으면 어떻게 될까요? 시원한 소리는 나지 않고, <strong>손바닥과 손목만 "징~" 하고 부르르 떨리며 찌릿하고 불타듯 얼얼해집니다.</strong> 힘이 공중으로 터져 나가지 못하고 내 손 안에 갇혀 헛떨림(열)으로 변해버렸기 때문입니다.',
          '스마트폰 속 OLED 분자도 이와 똑같습니다! 배터리가 아무리 힘차게 전기를 밀어 넣어줘도, <strong>분자가 떨리는 박자(고유 진동수)가 빛의 파동과 딱 맞지 않으면</strong> 에너지가 밖으로 뻗어나가지 못합니다.',
          '결국 75%의 전자는 빛이 되지 못한 채, 제자리에서 분자만 덜덜 떨게 만드는 <strong>"헛떨림(열 진동)"</strong>으로 낭비되고 마는 것입니다.'
        ],
        callout: {
          icon: 'flame',
          title: '헛진동(열) 메커니즘',
          text: '진동수(박자) 불일치 ➔ 에너지가 밖으로 터지지 못함 ➔ 제자리 헛떨림(열) 75% 발생'
        },
        image: 'reader_oled_2_vibration.jpg',
        imageCaption: '박자가 맞지 않아 에너지가 갇힌 채 격렬하게 헛떨리며 열을 내는 분자'
      },
      ...
      // 3장: 양자 시뮬레이션
      {
        ...
        lead: '"그렇다면 분자가 헛떨리지 않고 빛으로 한 방에 터져 나가게 박자를 바꿀 순 없을까?"',
        paragraphs: [
          ...
          '그리고 마침내 에너지가 열로 새어나가지 않고 오직 빛으로만 시원하게 뿜어져 나오는 <strong>"완벽한 정타 박자(공명 진동수)"</strong>를 찾아냈습니다. 원자 사이의 결합을 레고 블록처럼 단단히 조여 분자의 진동수를 완벽하게 재설계한 것입니다!'
        ],
        callout: {
          icon: 'cpu',
          title: 'KAIST 양자 시뮬레이션 기술',
          text: '1조 분의 1초 단위 분자 진동 계산 ➔ 원자 결합 보강 ➔ 정타 박자(진동수)로 재설계'
        },
      ...
      // 4장: 100% 정타의 기적
      {
        ...
        paragraphs: [
          '전기가 들어오는 즉시, 빗맞음 없이 <strong>100% 깨끗하고 찬란한 청색 빛으로 펑 터져 날아갔습니다!</strong> 손목을 아프게 하던 헛떨림(열)이 완벽히 사라진 것입니다.',
