...
window.worksheetModalData.oled = {
  ...
  3: {
    ...
    student: `
      ...
      <p style="font-size:0.95rem; color:#1e293b; margin:1.25rem 0 0.8rem; font-weight:700;">1. 다음 설명이 맞으면 O, 틀리면 X를 선택하시오.</p>
      <div class="ws-ox-quiz" style="margin-bottom:2.25rem;">
        <div class="ws-ox-item">
          <span class="ws-ox-statement">(1) 배터리 전기가 공급되면 분자 내 전자의 활동으로 공급된 에너지 전체(100%)가 화면 빛으로 방출된다.</span>
          <div class="ws-ox-group" data-answer="X">
            <button type="button" class="ws-ox-btn" data-choice="O">O</button>
            <button type="button" class="ws-ox-btn" data-choice="X">X</button>
          </div>
        ...
        <div class="ws-ox-item">
          <span class="ws-ox-statement">(2) 공급된 에너지의 75%는 빛을 내지 못하고 분자 진동에 의한 열로 손실되어 전기를 낭비한다.</span>
          <div class="ws-ox-group" data-answer="O">
            <button type="button" class="ws-ox-btn" data-choice="O">O</button>
            <button type="button" class="ws-ox-btn" data-choice="X">X</button>
          </div>
      ...
      <p style="font-size:0.95rem; color:#1e293b; margin:2.25rem 0 0.8rem; font-weight:700;">2. 스마트폰 화면에 전기를 공급했을 때 75%의 에너지가 열로 버려져 일어나는 문제점을 서술하시오.</p>
      <div class="answer-box" style="padding:0.85rem 1rem; margin-bottom:2rem;">
        <div style="display:flex; align-items:center; gap:0.25rem; margin-bottom:0.45rem; font-weight:600; color:#1e293b;">
          <i data-lucide="corner-down-right"></i> <span>서술 내용:</span>
        </div>
        <textarea class="ws-textarea-input" rows="3" data-answer="스마트폰 배터리 전기가 공급되면 분자 내 전자의 활동 과정에서 에너지의 75%가 빛을 내지 못하고 열로 손실됩니다. 이로 인해 배터리가 빠르게 닳아 사용 시간이 단축되고, 기기가 뜨거워지며, 지속적인 열 때문에 발광 분자가 손상되어 화면 수명이 줄어들고 잔상(번인)이 발생하는 심각한 문제가 일어납니다."></textarea>
      </div>
    `,
    teacher: `
      <h4 style="color:#059669; margin:1.25rem 0 0.8rem;">1. O / X 퀴즈 정답 및 해설</h4>
      <div class="callout-box" style="background:#fff1f2; border-left-color:#e11d48; font-size:0.9rem; line-height:1.75; margin-bottom:2.25rem;">
        (1) <strong>X</strong> : 배터리 전기가 공급되면 분자 내 전자의 활동으로 방출되는 에너지 중 빛으로 전환되는 것은 25%에 불과하며 75%는 빛을 내지 못하고 열로 손실됩니다.<br>
        (2) <strong>O</strong> : 전자의 활동 과정에서 75%의 에너지는 빛 대신 분자의 강한 진동으로 바뀌어 열로 손실됩니다.<br>
        (3) <strong>O</strong> : 낭비된 열은 배터리 조기 방전의 주범이며, 높은 온도로 인해 빛을 내는 분자가 파괴되면서 화면 번인(잔상) 현상을 유발합니다.
      </div>

      <h4 style="color:#059669; margin:2.25rem 0 0.8rem;">2. 75% 열 손실 문제점 모범 답안</h4>
      <div class="callout-box" style="background:#fff1f2; border-left-color:#e11d48; margin-bottom:2rem;">
        <span class="answer-arrow"><i data-lucide="corner-down-right"></i></span> <strong>모범 답안:</strong> 
        스마트폰 배터리 전기가 공급되면 분자 내 전자의 활동 과정에서 에너지의 75%가 빛을 내지 못하고 열로 손실됩니다. 이로 인해 배터리가 빠르게 닳아 사용 시간이 단축되고, 기기가 뜨거워지며, 지속적인 열 때문에 발광 분자가 손상되어 화면 수명이 줄어들고 잔상(번인)이 발생하는 심각한 문제가 일어납니다.
      </div>
    `
  },
  4: {
    ...
    student: `
      ...
      <div class="ws-ox-quiz" style="margin-bottom:2rem;">
        <div class="ws-ox-item">
          <span class="ws-ox-statement">(1) 파란색 빛은 빨강·초록빛보다 에너지가 높아 분자 결합이 깨지기 쉽고 수명이 가장 짧다.</span>
          <div class="ws-ox-group" data-answer="O">
            <button type="button" class="ws-ox-btn" data-choice="O">O</button>
            <button type="button" class="ws-ox-btn" data-choice="X">X</button>
          </div>
