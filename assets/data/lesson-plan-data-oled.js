            ...
            <table class="data-table" style="font-size:0.88rem; margin:0.5rem 0 1.25rem 0;">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <th style="text-align:center; white-space:nowrap;">준비물</th>
                  <td colspan="2">스마트기기(태블릿/노트북), 가상실험실(lab.html) [전자의 계단 점프 시뮬레이터], 활동지</td>
                </tr>
                <tr>
                  <th style="text-align:center; white-space:nowrap;">주의사항</th>
                ...
                <tr>
                  <td style="text-align:center; vertical-align:middle; white-space:nowrap; background-color:#f1f5f9;"><strong>도입</strong></td>
                  <td colspan="3">• 전차시 복습: 자외선(센 에너지)과 가시광선(약한 에너지)의 차이 상기<br>• 트램펄린 비유: "사람이 높이 뛰었다가 내려올 때 무슨 일이 일어날까?"</td>
                  <td>• 입자 모형의 시각적 비유 활용</td>
                </tr>
                <tr>
                  <td style="text-align:center; vertical-align:middle; white-space:nowrap; background-color:#f1f5f9;"><strong>전개</strong></td>
                  <td colspan="3">• <strong>원자 모형 복습:</strong> 원자핵과 주위를 도는 가벼운 음(-)전하 전자<br>• <strong>전자의 에너지 계단 3단계:</strong><br>  1) 바닥 상태 전자가 자외선 에너지를 흡수하여 3층 들뜬 상태로 점프<br>  2) 3층이 불안정하여 전자가 부르르 떨며(분자 진동) 에너지를 <strong>열</strong>로 방출<br>  3) 남은 에너지를 알록달록 <strong>가시광선 형광</strong>으로 뿜어내며 1층으로 착지<br>• <strong>시뮬레이션 탐구:</strong> 디지털 전자의 계단 점프 가상 실험실 조작 실습<br>• <strong>에너지 보존:</strong> [흡수한 자외선] = [방출된 형광빛] + [흘린 열에너지]</td>
                  <td>• 수식 대신 '에너지 보존 계단 그림'으로 정성적 이해 유도<br>• <strong>[과정평가]</strong> 시뮬레이터 조작을 통해 전자의 상태 변화를 구두로 설명할 수 있는지 확인</td>
                </tr>
                <tr>
                  <td style="text-align:center; vertical-align:middle; white-space:nowrap; background-color:#f1f5f9;"><strong>정리</strong></td>
                  <td colspan="3">• 전자의 에너지 계단 3단계 핵심 낱말 퀴즈<br>• 활동지 [활동 2] 전자의 점프와 사라진 에너지 서술형 문항 작성</td>
                  <td>• 서술형 힌트 제공</td>
                </tr>
              </tbody>
            </table>
          ...
          <div class="chrome-tab-panel" role="tabpanel">
            ...
            <table class="data-table" style="font-size:0.88rem; margin:0.5rem 0 1.25rem 0;">
              ...
              <tbody>
                ...
                <tr>
                  <th style="text-align:center; white-space:nowrap;">탐구방법</th>
                  <td>실물 교구 비교 관찰(형광 vs 인광), 스핀 입자 모형 조작, 확률 계산 및 토의</td>
                  <th style="text-align:center; white-space:nowrap;">준비물</th>
                  <td colspan="2">형광펜, 야광(축광) 스티커, 암실 상자, 스마트폰 디스플레이 구조 자료, 활동지</td>
                </tr>
                <tr>
                  <th style="text-align:center; white-space:nowrap;">주의사항</th>
                  <td>단일항과 삼중항의 양자역학 수식 대신 '회전 팽이 방향(↑↓ vs ↑↑)'과 비상문 비유로 지도</td>
                  <th style="text-align:center; white-space:nowrap;">수업자료</th>
                  <td colspan="2">
                    <div style="display:inline-flex; gap:0.45rem; flex-wrap:wrap; align-items:center;">
                ...
                <tr>
                  <td style="text-align:center; vertical-align:middle; white-space:nowrap; background-color:#f1f5f9;"><strong>도입</strong></td>
                  <td colspan="3">• 실물 비교: 형광펜(조명 끄면 즉시 꺼짐) vs 야광 스티커(불 꺼도 수 시간 동안 빛남)<br>• "왜 둘은 빛을 내뿜는 시간에 엄청난 차이가 날까?"</td>
                  <td>• 실물 교구 조작으로 흥미 유발</td>
                </tr>
                <tr>
                  <td style="text-align:center; vertical-align:middle; white-space:nowrap; background-color:#f1f5f9;"><strong>전개</strong></td>
                  <td colspan="3">• <strong>전자의 팽이 회전(스핀) 모형:</strong><br>  - 마주보고 도는 전자쌍 (단일항, ↑↓): 비상문 활짝 열려 1억 분의 1초 만에 형광 방출<br>  - 나란히 도는 전자쌍 (삼중항, ↑↑): 비상문 잠겨 천천히 갇혀서 인광 방출<br>• <strong>스마트폰 화면(OLED) 구동:</strong> 배터리의 전기(전류)를 유기 반도체 분자에 직접 주입 [9과14-02]<br>• <strong>75% 배터리 도둑의 충격적 확률:</strong><br>  - 전기를 넣으면 4개 중 <strong>단 1개(25%)만</strong> 단일항이 되어 빛을 냄<br>  - 무려 <strong>3개(75%)는</strong> 삼중항에 갇혀 빛 대신 <strong>열</strong>을 내뿜어 스마트폰을 뜨겁게 달굼!<br>• 스마트폰 소비 전력, 발열, 배터리 수명 저하의 과학적 원인 토의 [9과14-03]</td>
                  <td>• 양자 스핀 수식 대신 '회전 팽이' 비유로 직관화<br>• <strong>[과정평가]</strong> 단일항과 삼중항의 차이를 전자의 회전 방향과 연결하여 구분하는지 평가</td>
                </tr>
                <tr>
                  <td style="text-align:center; vertical-align:middle; white-space:nowrap; background-color:#f1f5f9;"><strong>정리</strong></td>
                  <td colspan="3">• 25% 발광 vs 75% 열 손실 딜레마 정리<br>• "갇혀서 열만 내는 75%의 전자를 구출할 방법은 없을까?" 질문으로 4차시 예고</td>
                  <td>• 활동지 3번 연계</td>
                </tr>
              </tbody>
            </table>
          ...
          <div class="chrome-tab-panel" role="tabpanel">
            ...
            <table class="data-table" style="font-size:0.88rem; margin:0.5rem 0 1.25rem 0;">
              ...
              <tbody>
                ...
                <tr>
                  <th style="text-align:center; white-space:nowrap;">탐구방법</th>
                  <td>빛의 삼원색(RGB) 관찰, 신소재 분자 구조 스케치 및 모둠 기획서 작성, 1분 피칭 발표</td>
                  <th style="text-align:center; white-space:nowrap;">준비물</th>
                  <td colspan="2">스마트기기, 분자 디자이너 기획서 양식, 색연필/마커, 평가 루브릭</td>
                </tr>
                <tr>
                  <th style="text-align:center; white-space:nowrap;">주의사항</th>
                  <td>빛의 삼원색 합성 원리와 화학 결합 안정성을 융합적으로 고려하고 루브릭 기반 상호 평가 유도</td>
                  <th style="text-align:center; white-space:nowrap;">수업자료</th>
                  <td colspan="2">
                    <div style="display:inline-flex; gap:0.45rem; flex-wrap:wrap; align-items:center;">
                ...
                <tr>
                  <td style="text-align:center; vertical-align:middle; white-space:nowrap; background-color:#f1f5f9;"><strong>도입</strong></td>
                  <td colspan="3">• 전차시 상기: 75%의 갇힌 전자를 구출하는 대한민국의 최첨단 과학 뉴스 소개 (KAIST CPRL 이영민 교수팀 연구 성과)</td>
                  <td>• 첨단 과학 연구에 대한 자긍심 고취</td>
                </tr>
                <tr>
                  <td style="text-align:center; vertical-align:middle; white-space:nowrap; background-color:#f1f5f9;"><strong>전개</strong></td>
                  <td colspan="3">• <strong>KAIST의 두 가지 구출 마법:</strong><br>  1) <strong>핫 엑시톤(Hot Exciton):</strong> 고에너지 옥상 우회로로 번개처럼 단일항으로 건너가는 초고속 구름다리<br>  2) <strong>TADF(열활성 지연형광):</strong> 주변 공기의 미세한 열을 흡수해 단일항으로 점프<br>  <i data-lucide="check-circle-2"></i> <strong>결과: 75%를 구출하여 100% 발광 효율 달성!</strong><br>• <strong>빛의 삼원색과 영상 장치:</strong> 스마트폰 화면의 RGB 화소 관찰 [9과10-03]<br>• <strong>청색 OLED의 난제:</strong> 에너지가 너무 세서 쉽게 깨지는 파란색 분자의 수명 한계<br>• <strong>[모둠 프로젝트] 미래 청색 OLED 분자 디자이너:</strong> 결합을 단단하게 보강한 나만의 고효율 파란색 발광 분자 및 롤러블 디스플레이 기획서 작성 [9과23-01]</td>
                  <td>• 화학 분자 설계 + 물리 빛 합성 + 디스플레이 공학 융합 유도<br>• <strong>[산출물평가]</strong> 분자 디자이너 기획서 창의성 및 과학적 타당성 평가 (루브릭 적용)</td>
                </tr>
                <tr>
                  <td style="text-align:center; vertical-align:middle; white-space:nowrap; background-color:#f1f5f9;"><strong>정리</strong></td>
                  <td colspan="3">• 모둠별 분자 디자인 아이디어 1분 스피치 발표<br>• 3차원 루브릭 기반 학생 상호평가 및 단원 총정리, 미래 과학 기술 진로 로드맵 공유</td>
                  <td>• 세특 기재용 관찰 기록 작성</td>
                </tr>
              </tbody>
            </table>
          </div>
